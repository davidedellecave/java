...
public class JcaUtils {
	...
	public static KeyStore createCredentials() throws Exception {
		...
		X500PrivateCredential interCredential = JcaUtils.createIntermediateCredential(rootCredential.getPrivateKey(),
				rootCredential.getCertificate());
		X500PrivateCredential endCredential = JcaUtils.createEndEntityCredential(interCredential.getPrivateKey(),
